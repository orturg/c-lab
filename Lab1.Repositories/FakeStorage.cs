...
namespace Lab1.Repositories.Storage;

/// <summary>
/// Клас штучного сховища, що імітує базу даних під час розробки та тестування
/// </summary>
public static class FakeStorage
{
    public static readonly List<WarehouseModel> Warehouses;
